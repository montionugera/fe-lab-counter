...
export const privacyPolicyElement = (
    <div>
        <div>
            <div>
                <h1>Privacy Policy of Joymify</h1>
                <p>
                    {`This privacy policy has been compiled to better serve those who are
          concerned with how their "Personally identifiable information" (PII)
          is being used online. PI is information that can be used on its own or
          ...
          Information in accordance with our website.`}
                ...
                <p>
                    ...
                    address, credit card information or other details so that we
                    can provide our services to you.
                </p>
                <h4>When do we collect information?</h4>
                <p>
                    We collect information from you when you register on our
                    site, place an order, subscribe to a newsletter, fill out a
                ...
                <ul>
                    <li>
                        To personalize your experience on our site and to allow
                        us to deliver the type of content and product offerings
                ...
                <p>
                    Our site is reviewed on a regular basis for security
                ...
                <p>
                    ...
                    encrypted via Secure Socket Layer (SSL) technology. We do
                    not store credit/debit card information on our systems.
                </p>
                <p>
          ...
          the correct way to modify your cookies.`}
                ...
                <p>
                    You can request to have your information removed by clicking
                    on the Contact Us/Live Chat button on this or the home page.
                </p>
                <p>
                    Please note that we may maintain information about an
                    individual sales transaction in order to complete that
                    transaction and for record keeping purposes.
                </p>
          ...
          safety.`}
                ...
                <p>
                    ...
                    your personal information if required to do so by law or in
          ...
          obligated not to disclose or use it for any other purpose.`}
                ...
                <p>
                    We provide paid products and/or services on our Website. In
