...
export const termsCondElem = (
    <div>
        <h2>Website Terms and Conditions</h2>
        <p>
            Last updated <span> 16 June 2021</span>
        </p>
        <p>
        ...
        <p>
            ...
            (“you”) and
            <span> Joymify </span> (“we,” “us” or “our”), concerning your access
            to and use of the <span>[website name.com]</span> website as well as
        ...
        <p>
            ...
            submit a written counter notification to{' '}
        ...
        <p>
            ...
            state and federal courts located in<span> [name of county]</span>{' '}
            County, <span>[name of state]</span>, and the Parties hereby consent
        ...
        <p>
            ...
            <span>______</span> days before initiating arbitration. Such
        ...
        <p>
            ...
            way to the Site be commenced more than <span>_____</span> years
        ...
        <p>
            ...
            limited by the AAA Consumer Rules.{' '}
            <span>
                [If such costs are determined to by the arbitrator to be
        ...
        <p>
            <span>nusso.pasit@gmail.com</span>
        </p>
    </div>
)
